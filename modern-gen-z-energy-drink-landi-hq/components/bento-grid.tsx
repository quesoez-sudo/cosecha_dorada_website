...
import { Wine, Leaf, Calendar, ShieldCheck } from "lucide-react"

const features = [
  {
    icon: Wine,
    title: "10%",
    subtitle: "Vol. Alcohol",
    description: "Fermentación artesanal natural",
    accent: "#F4B83F",
  },
  {
    icon: Leaf,
    title: "100%",
    subtitle: "Frutas Colombianas",
    description: "Sin concentrados ni aditivos",
    accent: "#6F8F32",
  },
  {
    icon: Calendar,
    title: "2025",
    subtitle: "Primera Cosecha",
    description: "Recién elaborado, lleno de vida",
    accent: "#E86A20",
  },
  {
    icon: ShieldCheck,
    title: "0",
    subtitle: "Aditivos Artificiales",
    description: "Solo fruta, agua y proceso artesanal",
    accent: "#D9786F",
  },
]
...
function FeatureCard({ feature, index }: { feature: (typeof features)[0]; index: number }) {
  ...
  return (
    ...
    >
      ...
      <div className="relative bg-[#173A2A] rounded-2xl p-5 border border-white/10 overflow-hidden h-full">
        <motion.div
        ...
        <div className="relative z-10 flex flex-col h-full min-h-[140px]">
          ...
          <div className="flex-1">
            <motion.div
            className="text-3xl font-display tracking-[-0.04em] text-white"
...
export function BentoGrid() {
  ...
  return (
    <section id="formula" className="relative py-16 bg-[#244A36] overflow-hidden">
      <div className="absolute inset-0 bg-gradient-to-b from-[#244A36] via-[#173A2A] to-[#244A36]" />
      ...
      <div ref={ref} className="max-w-5xl mx-auto px-6 relative z-10">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
          {features.map((feature, index) => (
            <FeatureCard key={feature.title + feature.subtitle} feature={feature} index={index} />
          ))}
        </div>
      </div>
    </section>
